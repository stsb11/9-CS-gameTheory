...
- The =payoff matrix= of their decisions is as following:
  [[./img/payoff-mtarix-advertising.png/]]
...
- Formally, =Nash Equilibrium= is a set of strategies for each player where the optimal outcome of a game is where there is no incentive for any players to change their initial strategy given what other players are doing.
