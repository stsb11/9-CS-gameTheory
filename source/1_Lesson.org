...
#+BEGIN_HTML
<iframe allowtransparency="true" width="485" height="402" src="http://scratch.mit.edu/projects/embed/86810467/?autostart=true" frameborder="0" allowfullscreen>
</iframe>
#+END_HTML 
...
- We start with a high-level plan; this is written in pseudocode to help work out the sequence of instructions we'll need to code before we start.
   ...
   - LOOP THESE NEXT INSTRUCTIONS UNTIL THERE ARE NO STICKS LEFT:
      - The current *player* makes a move.
      - Change the current player.
      - Output how many sticks remain.
   - When the sticks have run out, announce the winner.

- Open [[https://scratch.mit.edu/projects/86929754/#editor][this]] link on the Scratch site. If you've a Scratch account, you can log into it at this point. If you've not got one (or can't remember your password), you can always use the 'File -> Download to your Computer' link in the top right-hand corner when you've finished your work.

** Code It
:PROPERTIES:
:HTML_CONTAINER_CLASS: code
:END:
- You've now got the code we designed above all set out.
[[./img/w1_1.png]]
- Because we broke all the main coding ideas out into blocks (called functions when coding), this makes the main program looking nice and clear.
...
- We now need to define the different functions, to make the program work. 
- If you're feeling bold, you could even try to implement an AI to play against once you get this working. 
...
- People tend to make mistakes/cheat though, so we need to include a little 'data validation' to ensure they're making a valid move.
...
- *Platinum:* Implement a one-player version with a computer opponent. The computer should randomly choose to play either a 1, 2 or 3. Bonus points if you implement a strategy that means the computer will always win.
